...
export class PaymentController {
  ...
  @ApiBody({
    description:
      "Dados do checkout, incluindo billingTypes, chargeTypes, items, etc.",
    type: Object,
    examples: {
      default: {
  ...
  async createCheckout(@Body() body: Record<string, unknown>) {
  ...
  async createPixCheckout(@Body() body: Record<string, unknown>) {
  ...
  @ApiOperation({
    summary: "Cria um checkout de pagamento via cartão de crédito à vista",
  })
  @ApiBody({
    description:
      "Dados do checkout. billingTypes será forçado para ['CREDIT_CARD'] e chargeTypes para ['DETACHED'].",
    type: Object,
    examples: {
      default: {
  ...
  async createCreditCardCheckout(@Body() body: Record<string, unknown>) {
  ...
  @ApiOperation({
    summary: "Cria um checkout de pagamento via cartão de crédito parcelado",
  })
  @ApiBody({
    description:
      "Dados do checkout. billingTypes será forçado para ['CREDIT_CARD'] e chargeTypes para ['INSTALLMENT'].",
    type: Object,
    examples: {
      default: {
  ...
  async createInstallmentCheckout(@Body() body: Record<string, unknown>) {
    body.billingTypes = ["CREDIT_CARD"];
  ...
  @ApiBody({
    description:
      "Dados do checkout. billingTypes será forçado para ['CREDIT_CARD'] e chargeTypes para ['RECURRENT'].",
    type: Object,
    examples: {
      default: {
  ...
  async createRecurrenceCheckout(@Body() body: Record<string, unknown>) {
    body.billingTypes = ["CREDIT_CARD"];
